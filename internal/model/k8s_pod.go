...
type K8sPod struct {
	...
	Name          string     `json:"name" gorm:"size:63;not null;comment:Pod名称"`
	Namespace     string     `json:"namespace" gorm:"size:63;not null;index;comment:命名空间"`
	WorkloadName  string     `json:"workload_name" gorm:"size:100;comment:工作负载名称"`
	...
	NodeName      string     `json:"node_name" gorm:"size:100;comment:节点名称"`
